...
蜂鸟vpn完全免费，目前依靠Google 广告维持服务器开销。

标准节点可以立即使用，VIP节点需要先主动观看广告（签到/抽奖等）获取金币，然后兑换为VIP流量即可使用VIP高速节点。

如果APP不能让你满意，或者在Google Play给非五星评价，请立刻删除APP并关闭页面，节省蜂鸟有限的资源给需要的人，建议你使用其他APP。
