...
您可以在评论结尾留下您的ID(帮助|关于栏显示的6位大写字母和数字)，为了感谢支持的用户，我们提供2种奖励（2选1，请在评论中说明，如果未说则默认选1），奖励永久有效：
...
a. 示例：“balabala（这里是评论）。**XXXYYY**”或者“balabala，（这里是评论）。**XXXYYZ#2**”
【请注意格式，把ID加#1或者#2放在您评论的最后。评论太短可能会被Google认为是垃圾评论而不显示，请稍微写几句。。】。
